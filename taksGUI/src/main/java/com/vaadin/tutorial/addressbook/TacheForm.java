 ...
 */
public class TacheForm extends FormLayout {
    ...
    // il faut que les widgets aient exactement le nom des attributs de la classe
    BeanFieldGroup<Tache> formFieldBindings;
    ...
    private void buildLayout() {
		...
		addComponents(actions, label, datePrevu);
    }
...
//                    tache.getDatePrevu());
    ...
    void edit(Tache tache) {
        ...
        if(tache != null) {
            ...
            formFieldBindings = BeanFieldGroup.bindFieldsBuffered(tache, this);
            label.focus();
        }
        setVisible(tache != null);
    }

    @Override
    public TacheUI getUI() {
        return (TacheUI) super.getUI();
    }
